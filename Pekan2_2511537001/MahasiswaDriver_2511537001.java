...
public class MahasiswaDriver_2511537001 {
	...
	public static void tambahMahasiswa(ArrayList<Mahasiswa_2511537001> list,Scanner sc){
		...
		list.add(new Mahasiswa_2511537001(nim,nama,prodi));
		System.out.println("Mahasiswa berhasil ditambahkan.");
	
	}
	//3. Method untuk tampilkan semua data
	public static void tampilkanSemuaMahasiswa(ArrayList<Mahasiswa_2511537001> list){
		if (list.isEmpty()) {
			System.out.println("Daftar mahasiswa kosong.");
		}else {
			System.out.println("Data Mahsiswa");
			for (Mahasiswa_2511537001 mhs : list) {
				System.out.println(mhs);
			}
		}
	}
	//4. Method untuk hapus mahasiswa berdasarkan NIM
	public static void hapusMahasiswa(ArrayList<Mahasiswa_2511537001> list,Scanner sc){
	...
	public static void cariMahasiswa(ArrayList<Mahasiswa_2511537001>list,Scanner sc) {
	...
	public static void main(String[] args) {
		ArrayList<Mahasiswa_2511537001> mahasiswaList = new ArrayList<>();
