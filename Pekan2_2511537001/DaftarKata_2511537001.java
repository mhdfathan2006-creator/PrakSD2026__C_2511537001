...
public class DaftarKata_2511537001 {
	private final ArrayList<String> data;
	//Konstruktor: inisialiasi list kosong
	public DaftarKata_2511537001() {
		this.data= new ArrayList<>	();
		
		}
	/** Menambahkan elemen di akhir list. */
	public void tambah_2511537001(String elemen) {
		data.add(elemen);
		
	}
	/* Menambahkan elemen pada indeks tertentu (menyisipkan).**/
	public void tambahPada_2511537001(int index,String elemen) {
	 ...
	 */
	public void ubahElemen_2511537001(int index,String nilaiBaru) {
	 ...
	 */
	public String hapusElemen_2511537001(int index) {
	 ...
	 * 
	 */
	public void iterasiCetak_2511537001() {
