...
public final class Jam_2511537001 {
    ...
    // --- Relasional ---
    public int compareTo(Jam_2511537001 other) {
    ...
    // --- Aritmatika ---
    public Jam_2511537001 plus(Jam_2511537001 other) {
        return fromSeconds(this.toSeconds() + other.toSeconds());
    }

    public Jam_2511537001 minus(Jam_2511537001 other) {
    ...
    public Jam_2511537001 nextSecond() {
        return fromSeconds(this.toSeconds() + 1);
    }

    public Jam_2511537001 nextSeconds(int n) {
        return fromSeconds(this.toSeconds() + Math.max(0, n));
    }

    public Jam_2511537001 prevSecond() {
        return fromSeconds(Math.floorMod(
            this.toSeconds() - 1,
            24 * 3600
        ));
    ...
    public Jam_2511537001 prevnSeconds(int n) {
        return fromSeconds(Math.floorMod(
    ...
    // --- Durasi ---
    public static int durasiDetik(Jam_2511537001 awal, Jam_2511537001 akhir) {
